...
public class FortnightlyMeetingController {
	...
	@GetMapping
	public WSResponse<List<FortnightlyMeetingVO>> getFortnightlyMeetingsByFinancialYear(@RequestParam String financialYear) {
		List<FortnightlyMeetingVO> fortnightlyMeetingVOs = fortnightlyMeetingService.getFortnightlyMeetingsByFinancialYear(financialYear);
	...
	@PostMapping
	public WSResponse<String> genearteAndSaveFortnightlyMeetingsByFinancialYear(@RequestBody @Valid FinancialYearVO financialYearVO) {
