...
public class RevenueEntryVO implements Serializable {
	...
	public RevenueEntryVO() {

	}

	public RevenueEntryVO(String businessUnit, String strategicBusinessUnit, String strategicBusinessUnitHead,
			String businessDevelopmentManager, String businessType, String account, String region, String location,
			String probabilityType, String cocPractice, String status) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RevenueEntryVO other = (RevenueEntryVO) obj;
