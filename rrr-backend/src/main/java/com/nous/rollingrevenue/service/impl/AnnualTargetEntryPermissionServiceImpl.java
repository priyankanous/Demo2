...
import com.nous.rollingrevenue.convertor.AnnualTargetEntryPermissionConverter;
...
public class AnnualTargetEntryPermissionServiceImpl implements AnnualTargetEntryPermissionService {
	...
	public void deleteAnnualTargetEntryPermissionById(Long annualTargetEntryPermissionId) {
		annualTargetEntryPermissionRepository.findById(annualTargetEntryPermissionId)
				.orElseThrow(() -> new RecordNotFoundException(ErrorConstants.RECORD_NOT_EXIST + annualTargetEntryPermissionId));
	...
	public AnnualTargetEntryPermissionVO getAnnualTargetEntryPermissionById(Long annualTargetEntryPermissionId) {
		AnnualTargetEntryPermission annualTargetEntryPermission = annualTargetEntryPermissionRepository.findById(annualTargetEntryPermissionId)
				.orElseThrow(() -> new RecordNotFoundException(ErrorConstants.RECORD_NOT_EXIST + annualTargetEntryPermissionId));
	...
	@Override
	@Transactional
	public void updateAnnualTargetEntryPermission(Long annualTargetEntryPermissionId, AnnualTargetEntryPermissionVO annualTargetEntryPermissionVO) {
		AnnualTargetEntryPermission annualTargetEntryPermission = annualTargetEntryPermissionRepository.findById(annualTargetEntryPermissionId)
				.orElseThrow(() -> new RecordNotFoundException(ErrorConstants.RECORD_NOT_EXIST + annualTargetEntryPermissionId));
